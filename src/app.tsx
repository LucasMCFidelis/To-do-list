...
export function App() {
  ...
  function changeCheckActivity() {
    setIsCheckedActivity(!isCheckedActivity)
  }
        ...
        <div className='w-full flex flex-col gap-3'>
          <div className="flex justify-between">
            <div className='relative flex-1'>
              <input onChange={changeCheckActivity} type="checkbox" value={activity} className='w-full absolute inset-0'/>
              <div className="flex justify-between">
                <div className="flex gap-3">
                  <svg className={isCheckedActivity ? 'block' : 'hidden'} width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <svg className={isCheckedActivity ? 'hidden' : 'block'} width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="0.5" y="0.5" width="25" height="25" rx="1.5" stroke="#6C63FF" />
                  </svg>
                  <h2 className='w-36 sm:w-auto'>Atividade 02</h2>
                </div>
              </div>
            </div>
